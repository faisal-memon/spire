...
func (ds *DataStore) CreateJoinToken(ctx context.Context, in *datastore.JoinToken) error {
	if err := ds.joinTokens.Create(ctx, joinTokenObject{JoinToken: in}); err != nil {
